{
  programs.plasma = {
    enable = true;
    shortcuts = {
      ActivityManager.switch-to-activity-28812b45-fb36-4972-841d-9ecd4116188e = [ ];
      ActivityManager.switch-to-activity-bb76733e-40d7-4526-b0e1-11a3905cfc38 = [ ];
      ...
      kwin."Switch to Desktop 1" = "Ctrl+Alt+1";
      ...
      kwin."Switch to Desktop 2" = "Ctrl+Alt+2";
      kwin."Switch to Desktop 20" = [ ];
      kwin."Switch to Desktop 3" = "Ctrl+Alt+3";
      kwin."Switch to Desktop 4" = "Ctrl+Alt+4";
      kwin."Switch to Desktop 5" = "Ctrl+Alt+5";
      kwin."Switch to Desktop 6" = "Ctrl+Alt+6";
      kwin."Switch to Desktop 7" = "Ctrl+Alt+7";
      kwin."Switch to Desktop 8" = "Ctrl+Alt+8";
      kwin."Switch to Desktop 9" = "Ctrl+Alt+9";
    ...
    configFile = {
      ...
      kactivitymanagerdrc.activities."28812b45-fb36-4972-841d-9ecd4116188e" = "Gaming";
      kactivitymanagerdrc.activities.bb76733e-40d7-4526-b0e1-11a3905cfc38 = "Default";
      kactivitymanagerdrc.activities-icons."28812b45-fb36-4972-841d-9ecd4116188e" = "activities";
      kactivitymanagerdrc.main.currentActivity = "bb76733e-40d7-4526-b0e1-11a3905cfc38";
      ...
      kcminputrc."Libinput/5426/183/Razer Razer DeathAdder V3 Pro".PointerAcceleration = 0.000;
      kcminputrc."Libinput/5426/183/Razer Razer DeathAdder V3 Pro".PointerAccelerationProfile = 1;
      kcminputrc."Libinput/5426/183/Razer Razer DeathAdder V3 Pro Mouse".Enabled = true;
      kcminputrc."Libinput/5426/183/Razer Razer DeathAdder V3 Pro Mouse".PointerAcceleration = 0.000;
      ...
      kwinrc.Desktops.Id_1 = "8f69d219-12fb-46ca-9ea9-b825f72d785e";
      kwinrc.Desktops.Id_2 = "721d7bc0-4d54-433a-94f0-6f489591b627";
      kwinrc.Desktops.Id_3 = "7d82d823-478e-4317-bec9-4f87d50703ed";
      kwinrc.Desktops.Id_4 = "6e0e5077-5476-4af6-8b74-5d4046f67faf";
      kwinrc.Desktops.Id_5 = "0ae2f30c-9835-4144-91dd-112f842a38de";
      kwinrc.Desktops.Id_6 = "a944c5c6-a183-49df-97b8-dd9322ea92d2";
      kwinrc.Desktops.Id_7 = "54bbb224-0058-4fcd-83b3-67589e999e22";
      kwinrc.Desktops.Name_1 = "Main";
      kwinrc.Desktops.Name_2 = "Firefox";
      kwinrc.Desktops.Name_3 = "Visual Studio Code";
      kwinrc.Desktops.Name_4 = "Terminal";
      kwinrc.Desktops.Name_5 = "Slack";
      kwinrc.Desktops.Name_6 = "Spotify";
      kwinrc.Desktops.Name_7 = "Chrome";
      ...
      kwinrulesrc."2abbafd6-ffd7-4812-bad1-3dc39de32260".wmclass = "spotify";
      ...
      kwinrulesrc."7f16798a-6266-4a07-89c5-a19018600402".title = "Visual Studio Code";
      kwinrulesrc."7f16798a-6266-4a07-89c5-a19018600402".titlematch = 2;
      kwinrulesrc."9690a13a-6b55-46e0-935c-d6f076b5e29d".desktopsrule = 2;
      kwinrulesrc.General.count = 6;
      kwinrulesrc.General.rules = "7f16798a-6266-4a07-89c5-a19018600402,bcffd43a-5b3d-40c0-9df5-9736e1dcb4ef,2abbafd6-ffd7-4812-bad1-3dc39de32260,c1726d46-1c79-41ed-b2b5-df493ecd4136,4cf2b99c-5fe1-479a-9e71-8430d2f614f5,dd6bc2a9-c3a4-4a9a-93ff-98f8b828650f";
      kwinrulesrc.bcffd43a-5b3d-40c0-9df5-9736e1dcb4ef.Description = "Firefox";
      kwinrulesrc.bcffd43a-5b3d-40c0-9df5-9736e1dcb4ef.desktops = "721d7bc0-4d54-433a-94f0-6f489591b627";
      kwinrulesrc.bcffd43a-5b3d-40c0-9df5-9736e1dcb4ef.desktopsrule = 2;
      kwinrulesrc.bcffd43a-5b3d-40c0-9df5-9736e1dcb4ef.title = "Mozilla Firefox";
      kwinrulesrc.bcffd43a-5b3d-40c0-9df5-9736e1dcb4ef.titlematch = 2;
      kwinrulesrc.c1726d46-1c79-41ed-b2b5-df493ecd4136.Description = "Slack";
      kwinrulesrc.c1726d46-1c79-41ed-b2b5-df493ecd4136.desktops = "0ae2f30c-9835-4144-91dd-112f842a38de";
      kwinrulesrc.c1726d46-1c79-41ed-b2b5-df493ecd4136.desktopsrule = 2;
      kwinrulesrc.c1726d46-1c79-41ed-b2b5-df493ecd4136.fullscreen = true;
      kwinrulesrc.c1726d46-1c79-41ed-b2b5-df493ecd4136.fullscreenrule = 2;
      kwinrulesrc.c1726d46-1c79-41ed-b2b5-df493ecd4136.wmclass = "slack";
      kwinrulesrc.c1726d46-1c79-41ed-b2b5-df493ecd4136.wmclasscomplete = true;
      kwinrulesrc.c1726d46-1c79-41ed-b2b5-df493ecd4136.wmclassmatch = 2;
      kwinrulesrc.dd6bc2a9-c3a4-4a9a-93ff-98f8b828650f.Description = "Everything else to desktop 1";
      kwinrulesrc.dd6bc2a9-c3a4-4a9a-93ff-98f8b828650f.desktops = "8f69d219-12fb-46ca-9ea9-b825f72d785e";
      kwinrulesrc.dd6bc2a9-c3a4-4a9a-93ff-98f8b828650f.desktopsrule = 2;
      kwinrulesrc.dd6bc2a9-c3a4-4a9a-93ff-98f8b828650f.types = 66491;
      kwinrulesrc.dd6bc2a9-c3a4-4a9a-93ff-98f8b828650f.wmclasscomplete = true;
      kxkbrc.Layout.DisplayNames = ",";
      kxkbrc.Layout.LayoutList = "us,no";
    ...
    dataFile = {
      "kate/anonymous.katesession"."Document 0".URL = "file:///home/dsharifi/Shortcuts.kksrc";
      ...
      "kate/anonymous.katesession".MainWindow0.Kate-MDI-Sidebar-1-Splitter = 1352;
      ...
      "kate/anonymous.katesession".MainWindow0.Kate-MDI-V-Splitter = "0,1352,0";
      ...
      "kate/anonymous.katesession"."MainWindow0-Splitter 0".Sizes = 2603;
